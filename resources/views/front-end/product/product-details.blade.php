                            ...
                            <div class="comment_list">
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img
                                                src="{{asset('/front')}}/img/product/single-product/review-1.png"
                                                alt=""
                                            />
                                        </div>
                                ...
                                <div class="review_item reply">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img
                                                src="{{asset('/front')}}/img/product/single-product/review-2.png"
                                                alt=""
                                            />
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img
                                                src="{{asset('/front')}}/img/product/single-product/review-3.png"
                                                alt=""
                                            />
                                        </div>
                                        <div class="media-body">
